...
options.add_argument('--arch', '-a', metavar='ARCH', default='resnet50',
                     choices=model_names,
                     help='model architecture: ' +
                          ' | '.join(model_names) +
                          ' (default: resnet50)')
options.set_defaults(data='gen/imagenet', epochs=90, batch_size=256, lr=0.1,
                     momentum=0.9, nesterov=False, weight_decay=1e-4,
                     lr_decay=0.1, lr_decay_step='30')
best_prec1 = 0
...
def main():
    ...
    if args.method == 'dft':
        ...
        optimizer = SparseFixedMaxSGD(get_rram_param_groups(model.named_parameters()),
                                 args.lr, momentum=args.momentum,
                                 weight_decay=args.weight_decay,
                                 balanced_row_num={'conv': args.conv_balanced_row_num,
                                                   'fc': args.fc_balanced_row_num},
                                 ...
                                 small_rram_size=args.small_rram_size,
                                 is_small_by_pos=args.is_small_by_pos)
    elif args.method == 'fsm':
        optimizer = SparseFixedSumSGD(get_rram_param_groups(model.named_parameters()),
                                 args.lr, momentum=args.momentum,
                                 weight_decay=args.weight_decay,
                                 balanced_row_num={'conv': args.conv_balanced_row_num,
                                                   'fc': args.fc_balanced_row_num},
                                 ...
                                 small_rram_size=args.small_rram_size,
                                 is_small_by_pos=args.is_small_by_pos)
    elif args.method == 'flr':
        optimizer = SparseFixedLRUSGD(get_rram_param_groups(model.named_parameters()),
                                 args.lr, momentum=args.momentum,
                                 weight_decay=args.weight_decay,
                                 rram_size=args.rram_size)

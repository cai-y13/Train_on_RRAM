...
__all__ = ['SparseFixedAccMaxSGD']


OLD_PYTORCH = '1.12' in torch.__version__


class SparseFixedAccMaxSGD(Optimizer):
    ...
    def __init__(self, params, lr=required, momentum=0, dampening=0,
        ...
        super(SparseFixedAccMaxSGD, self).__init__(params, defaults)
    ...
    def __setstate__(self, state):
        super(SparseFixedAccMaxSGD, self).__setstate__(state)
        for group in self.param_groups:
